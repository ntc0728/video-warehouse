...
- **ADR-023 断点宪法终版 + UI 缩放连续化 + 历史页独立分档（2026-09-07）**
  ...
  - **主网格 `--card-cols` 终版**：<768=3 / ≥768=4 / ≥1024=5 / ≥1280=6 / ≥1440=7 / ≥1920=8 / ≥2200=8（2200 内容区封顶，此后列数冻结）；`--page-pad-x` 16(<1440)→32(1440)→48(1920)→140(2560)；`--iptv-cols` 2(≤767)→3(768-1023)→4(1024-1439)→5(≥1440)。
