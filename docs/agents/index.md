# AGENTS.md 详情索引（docs/agents/）

> 精简版 AGENTS.md 只保留红线与索引表，详情按下表按需读取，避免全量加载。

| 主题 | 文件 | 何时读 |
|---|---|---|
| 架构/分层/代理/目录/Android 原生 | [architecture.md](./architecture.md) | 改 store/service/代理/目录结构/原生代码时 |
...
| 版本号/release-please | [versioning.md](./versioning.md) | 发版、改版本号时 |
| 开发命令/环境 | [env.md](./env.md) | 起服务、构建、跑测试时 |

> 注：本目录另有早期 `domain.md` / `issue-tracker.md` / `triage-labels.md`（模板遗留，与 AGENTS.md 拆分无关，暂保留）。
