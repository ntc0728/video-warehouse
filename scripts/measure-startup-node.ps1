...
# 启动开发服务器（使用 node 直接运行 vite）
$vitePath = "D:\trae\5.13\video-warehouse\node_modules\.bin\vite.cmd"
$process = Start-Process -FilePath "node" -ArgumentList $vitePath -PassThru -NoNewWindow -WorkingDirectory "D:\trae\5.13\video-warehouse"
