...
| `demos/demo-settings-desktop-layout-2026-09-06.html` | 设置页大屏布局 4 方案对比（**已拍板 2026-09-06：采用方案 A 原样保留 + 桌面端加 BackToTopButton（commit f0fecdd），B/C/D 未采用**）：A 现状基线（标题左+胶囊 tab 挤右上+内容满宽拉伸）/ B 左侧竖排导航（用户想法：tab 竖排图标+全称、内容限宽 860px，★推荐）/ C 窄图标栏 72px（紧凑取向）/ D 保持顶栏 + 整卡限宽居中 980px（保守解）；tab 可点、容器宽 900–1760px 可拖，token 对齐站点黑白灰体系 | 2026-09-06 |
